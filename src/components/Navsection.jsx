                                ...
                                <div className="flex justify-between items-center px-3 ">
                                        ...
                                        <div className="flex items-center">
                                                <ul className={` ${first ? "left-0" : "left-[-100%]"} flex items-center  gap-[28px] duration-300 mobileview2  max-lg:justify-center max-lg:flex-col max-lg:text-white max-lg:w-full max-lg:h-full  max-lg:fixed max-lg:top-0 max-lg:z-20 max-lg:bg-black max-lg:bg-[url(./assets/images/hero-section-bg-img.webp)] bg-no-repeat bg-center bg-cover`}>
                                                        <Link to="/hogar" onClick={() => setfirst(false)} className=' cursor-pointer transition after:duration-500 after:w-0 hover:after:w-full hover:after:left-0 after:absolute relative after:right-0  after:-bottom-1 after:rounded-xl  after:h-[2px] after:bg-white font-Inter text-[16px] font-medium leading-[25px] hover:text-white text-[#D2D7D9]'>Hogar</Link>
                                                        <Link to="/misión" onClick={() => setfirst(false)} className='cursor-pointer transition after:duration-500 after:w-0 hover:after:w-full hover:after:left-0 after:absolute relative after:right-0 after:-bottom-1 after:rounded-xl after:h-[2px] after:bg-white font-Inter text-[16px] font-medium leading-[25px] hover:text-white text-[#D2D7D9]'>Misión</Link>
                                                        <Link to="/tragamonedas" onClick={() => setfirst(false)} className='cursor-pointer transition after:duration-500 after:w-0 hover:after:w-full hover:after:left-0 after:absolute relative after:right-0 after:-bottom-1 after:rounded-xl after:h-[2px] after:bg-white font-Inter text-[16px] font-medium leading-[25px] hover:text-white text-[#D2D7D9]'>Tragamonedas</Link>
                                                        <Link to="/elegirnos" onClick={() => setfirst(false)} className='cursor-pointer transition after:duration-500 after:w-0 hover:after:w-full hover:after:left-0 after:absolute relative after:right-0 after:-bottom-1 after:rounded-xl after:h-[2px] after:bg-white font-Inter text-[16px] font-medium leading-[25px] hover:text-white text-[#D2D7D9]'>Por qué elegirnos</Link>
                                                        <Link to="/ofertas" onClick={() => setfirst(false)} className='cursor-pointer transition after:duration-500 after:w-0 hover:after:w-full hover:after:left-0 after:absolute relative after:right-0 after:-bottom-1 after:rounded-xl after:h-[2px] after:bg-white font-Inter text-[16px] font-medium leading-[25px] hover:text-white text-[#D2D7D9]'>Ofertas</Link>
