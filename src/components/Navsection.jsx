                        ...
                        <nav className=" max-w-[1140px] px-3 mx-auto w-full">
                                <div className="flex justify-between items-center px-3 ">
                                        <div className=" flex items-center ">
                                                <img className=" max-w-[209px] h-[42px] cursor-pointer" src={navlogo} alt="#" />
                                        </div>
                                        <div className="flex items-center">
                                                <ul className={` ${first ? "left-0" : "left-[-100%]"} flex items-center  gap-[28px] duration-300 mobileview2  max-lg:justify-center max-lg:flex-col max-lg:text-white max-lg:w-full max-lg:h-full  max-lg:fixed max-lg:top-0 max-lg:z-20 max-lg:bg-black`}>
                                                        <Link to="/" onClick={() => setfirst(false)} className=' cursor-pointer transition after:duration-500 after:w-0 hover:after:w-full hover:after:left-0 after:absolute relative after:right-0  after:-bottom-2  after:h-[2px] after:bg-white font-Inter text-[16px] font-medium leading-[25px] text-white'>Hogar</Link>
                                                        <Link to="/about" onClick={() => setfirst(false)} className='cursor-pointer transition after:duration-500 after:w-0 hover:after:w-full hover:after:left-0 after:absolute relative after:right-0 after:-bottom-2 after:h-[2px] after:bg-white font-Inter text-[16px] font-medium leading-[25px] text-white'>Misión</Link>
                                                        <Link to="/shop" onClick={() => setfirst(false)} className='cursor-pointer transition after:duration-500 after:w-0 hover:after:w-full hover:after:left-0 after:absolute relative after:right-0 after:-bottom-2 after:h-[2px] after:bg-white font-Inter text-[16px] font-medium leading-[25px] text-white'>Tragamonedas</Link>
                                                        ...
                                                        <Link className=' duration-300 hover:scale-95 block md:hidden relative'>
                                                                <button ><Commonbtns text="Acceso" /></button>
                                                                <a className=' absolute bottom-[-12%] left-[-3%]' href=""><Btnline /></a>
                                                        </Link>
                                                </ul>
                                        </div>
                                        <div className=' duration-300 hover:scale-95 hidden md:block relative'>
                                                <button ><Commonbtns  text="Acceso" /></button>
                                                <a className=' absolute bottom-[-12%] left-[-3%]' href=""><Btnline /></a>
                                        </div>
