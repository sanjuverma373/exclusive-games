        ...
        return (
                <div className=' relative '>
                        <div className=' max-w-[1140px] mx-auto px-3'>
                                ...
                                <div className=' bg-[#062025] border-[0.5px] border-[#819192] pt-[57px] pb-[32px] pr-[40px] pl-[47px] rounded-[16px]'>
                                        <div className=' grid lg:grid-cols-2 gap-6'>
                                                <div className=' flex flex-col items-center lg:items-start justify-center lg:justify-start relative'>
                                                        ...
                                                        <span className=' w-full max-w-[160px] h-full max-h-[162px] bg-gradient-to-r from-[#51C8EF] to-[#7AF57A] flex absolute top-[-6%] left-[5%] opacity-50 rounded-full blur-[50px]'></span>
                                                ...
                                                <div>
                                                        ...
                                                        <div className=' flex pb-3 gap-2'>
                                                                ...
                                                                <p className='font-Inter font-medium text-[14px] sm:text-[16px] leading-[25px] text-[#CDD2D3] text-center lg:text-start '>Disponibles Payku, Pix, Depósitos en Euros, Criptomonedas, Cargas manuales</p>
                                                        </div>
                                                        <div className=' flex pb-3 gap-2'>
                                                                <span>
                                                                        <Right />
                                                                </span>
                                                                <p className=' lg:text-start text-center font-Inter font-medium text-[14px] sm:text-[16px] leading-[25px] text-[#CDD2D3]'>Control de RTP (controlás qué porcentaje pagar)</p>
                                                        </div>
                                                        <div className=' flex pb-3 gap-2'>
                                                                <span>
                                                                        <Right />
                                                                </span>
                                                                <p className='font-Inter lg:text-start text-center font-medium text-[14px] sm:text-[16px] leading-[25px] text-[#CDD2D3]'>Bonos Editables, Happy Hours, Jackpots, Códigos Promocionales Regalo</p>
                                                        </div>
                                                        <div className=' flex pb-3 gap-2'>
                                                                <span>
                                                                        <Right />
                                                                </span>
                                                                <p className='font-Inter lg:text-start text-center font-medium text-[14px] sm:text-[16px] leading-[25px] text-[#CDD2D3]'>Aplicación para Android y Windows de regalo.</p>
                                                        </div>
                                                        <div className=' flex pb-3 gap-2'>
                                                                <span>
                                                                        <Right />
                                                                </span>
                                                                <p className='font-Inter lg:text-start text-center font-medium text-[14px] sm:text-[16px] leading-[25px] text-[#CDD2D3] pb-3'>Tiempo de creación 2 a 3 semanas</p>
                                                        </div>
                                ...
                                <div className='bg-[#062025] border-[0.5px] border-[#819192] rounded-[16px] mt-6 sm:mt-[64px]  py-[46px] bg-[url(./assets/images/spincrd2-bg-img.webp)] bg-no-repeat bg-center bg-cover relative'>
                                        <div className=' flex flex-col justify-center items-center'>
                                                ...
                                                <div className=' flex items-center justify-center'>
                                                        <div className=' duration-300 hover:scale-95 relative '>
                                                                <button ><Commonbtns custom=" !bg-gradient-to-r !from-[#7AF57A] !to-[#51C8EF] !text-black !border !border-0" text="Comprar ahora" /></button>
                                                                <a className=' absolute bottom-[-13%] left-[-3%]' href=""><Btnline /></a>
                                                        </div>
                                                </div>
                                        </div>
                                ...
                                <div className='bg-[#062025] border-[0.5px] border-[#819192] rounded-[16px] mt-6 sm:mt-[64px] pr-[40px] pl-[50px] py-[78px]'>
                                        <div className=' grid lg:grid-cols-2 gap-6'>
                                                <div>
                                                        ...
                                                        <p className=' font-Inter font-medium text-[14px] sm:text-[16px] text-center lg:text-start leading-[25px] text-[#CDD2D3] max-w-[401px] pb-[32px]'>Diseño totalmente personalizado. Contáctanos para un presupuesto.</p>
                                                ...
                                                <div className=' relative z-10 '>
                                                        ...
                                                        <span className=' w-full max-w-[162px] h-full max-h-[162px] bg-gradient-to-r from-[#51C8EF] to-[#7AF57A] flex absolute -top-[2%] right-[36px] opacity-50 rounded-full blur-[40px] -z-10'></span>
                        ...
                        <span className=' w-full max-w-[484px] h-full max-h-[484px] bg-gradient-to-r from-[#51C8EF] to-[#7AF57A] flex absolute top-[53%] -left-[10%] opacity-50 rounded-full blur-[180px] '></span>
